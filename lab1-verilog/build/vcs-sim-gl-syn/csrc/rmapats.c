...
void  rmaPropagate56wn(UB  * pcode, scalar  val);
...
void  rmaPropagate57s0(UB  * pcode, scalar  val);
...
void  rmaPropagate58s0(UB  * pcode, scalar  val);
...
void  rmaPropagate60wn(UB  * pcode, scalar  val);
...
void  rmaPropagate63wn(UB  * pcode, scalar  val);
...
void  rmaPropagate71wn(UB  * pcode, scalar  val);
...
void  rmaPropagate73wn(UB  * pcode, scalar  val);
...
void  rmaPropagate74wn(UB  * pcode, scalar  val);
...
void  rmaPropagate75wn(UB  * pcode, scalar  val);
