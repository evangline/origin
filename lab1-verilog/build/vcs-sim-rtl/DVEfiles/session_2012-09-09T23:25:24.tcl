...
# DVE reload session
# Saved on Sun Sep 9 23:25:24 2012
# Designs open: 1
...
#<Session mode="Reload" path="/work/cs250-af/lab1-verilog/build/vcs-sim-rtl/DVEfiles/session.tcl" type="Debug">
...
gui_sg_addsignal -group ${Group1} { gcdTestHarness_rtl.gcd.clk gcdTestHarness_rtl.gcd.operands_bits_A gcdTestHarness_rtl.gcd.operands_bits_B gcdTestHarness_rtl.gcd.operands_val gcdTestHarness_rtl.gcd.operands_rdy gcdTestHarness_rtl.gcd.result_bits_data }
...
catch { gui_list_select -id ${Data.1} {gcdTestHarness_rtl.gcd.result_bits_data }}
...
gui_wv_zoom_timerange -id ${Wave.1} 2129 2533
...
gui_marker_move -id ${Wave.1} {C1} 163
