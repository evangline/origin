...
# DVE full session
# Saved on Tue Oct 9 21:42:20 2012
# Designs open: 1
#   V1: trace.vpd
...
#   Group Config signal count = 5
#   Group Image Input signal count = 2
#   Group Image Output signal count = 2
...
#<Session mode="Full" path="/scratch/cs250-ab/lab-templates/lab3/emulator/debug.tcl" type="Debug">
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{251 122} {1431 826}}
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 273} {height 471} {show_state normal} {dock_state left} {dock_on_new_line true} {child_hier_colhier 261} {child_hier_coltype 84} {child_hier_col1 0} {child_hier_col2 1}}
set DLPane.1 [gui_create_window -type DLPane -parent ${TopLevel.1} -dock_state left -dock_on_new_line true -dock_extent 314]
set Data.1 [gui_share_window -id ${DLPane.1} -type Data]
gui_set_window_pref_key -window ${DLPane.1} -key dock_width -value_type integer -value 314
gui_set_window_pref_key -window ${DLPane.1} -key dock_height -value_type integer -value 472
gui_set_window_pref_key -window ${DLPane.1} -key dock_offset -value_type integer -value 0
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 313} {height 471} {show_state normal} {dock_state left} {dock_on_new_line true} {child_data_colvariable 254} {child_data_colvalue 188} {child_data_coltype 133} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2} {dataShowMode detail} {max_item_length 50}}
set Console.1 [gui_create_window -type Console -parent ${TopLevel.1} -dock_state bottom -dock_on_new_line true -dock_extent 105]
gui_set_window_pref_key -window ${Console.1} -key dock_width -value_type integer -value 1181
gui_set_window_pref_key -window ${Console.1} -key dock_height -value_type integer -value 105
gui_set_window_pref_key -window ${Console.1} -key dock_offset -value_type integer -value 0
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 1180} {height 105} {show_state normal} {dock_state bottom} {dock_on_new_line true}}
...
gui_show_window -window ${TopLevel.2} -show_state normal -rect {{62 112} {1431 826}}
...
gui_update_layout -id ${Wave.1} {{show_state maximized} {dock_state undocked} {dock_on_new_line false} {child_wave_left 397} {child_wave_right 967} {child_wave_colname 196} {child_wave_colvalue 196} {child_wave_col1 0} {child_wave_col2 1}}
...
gui_wv_zoom_timerange -id ${Wave.1} 0 315
