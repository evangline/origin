...
set ICC_NUM_CPUS                  2            ;# number of cpus for distributed processing;
					       ;# specify a number greater than 1 to enable it for classic router based route_opt and insert_redundant_via commands
set ICC_NUM_CORES                 2            ;# number of cores on the local host for multicore support;
...
set ICC_CTS_LAYER_LIST		"M3 M4 M5 M6 M7"	;# clock tree layers, usually M3 and above
