...
# DVE full session
# Saved on Sun Sep 9 14:19:59 2012
# Designs open: 1
...
#<Session mode="Full" path="/work/cs250-af/lab1-chisel/vlsi/build/vcs-sim-rtl/DVEfiles/session.tcl" type="Debug">
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{12 67} {724 614}}
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 168} {height 223} {show_state normal} {dock_state left} {dock_on_new_line true} {child_hier_colhier 140} {child_hier_coltype 100} {child_hier_col1 0} {child_hier_col2 1}}
...
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 236} {height 223} {show_state normal} {dock_state left} {dock_on_new_line true} {child_data_colvariable 140} {child_data_colvalue 100} {child_data_coltype 40} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2} {dataShowMode detail} {max_item_length 50}}
...
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 712} {height 173} {show_state normal} {dock_state bottom} {dock_on_new_line true}}
...
gui_sg_addsignal -group ${Group1} { gcdTestHarness_rtl.gcd.clk gcdTestHarness_rtl.gcd.io_operands_bits_A gcdTestHarness_rtl.gcd.io_operands_bits_B gcdTestHarness_rtl.gcd.io_operands_val gcdTestHarness_rtl.gcd.io_operands_rdy gcdTestHarness_rtl.gcd.A gcdTestHarness_rtl.gcd.B gcdTestHarness_rtl.gcd.state }
...
gui_view_scroll -id ${Data.1} -vertical -set 306
