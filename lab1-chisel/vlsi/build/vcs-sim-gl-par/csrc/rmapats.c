...
void  rmaPropagate45s0(UB  * pcode, scalar  val);
...
void  rmaPropagate50s0(UB  * pcode, scalar  val);
...
void  rmaPropagate62t0(UB  * pcode, UB  val);
...
void  rmaPropagate68wn(UB  * pcode, scalar  val);
...
void  rmaPropagate76wn(UB  * pcode, scalar  val);
...
void  rmaPropagate77wn(UB  * pcode, scalar  val);
...
void  rmaPropagate89wn(UB  * pcode, scalar  val);
...
void  rmaPropagate90wn(UB  * pcode, scalar  val);
...
void  rmaPropagate92wn(UB  * pcode, scalar  val);
...
void  rmaPropagate94wn(UB  * pcode, scalar  val);
...
void  rmaPropagate95wn(UB  * pcode, scalar  val);
...
void  rmaPropagate99wn(UB  * pcode, scalar  val);
...
void  rmaPropagate106wn(UB  * pcode, scalar  val);
...
void  rmaPropagate107wn(UB  * pcode, scalar  val);
...
void  rmaPropagate108wn(UB  * pcode, scalar  val);
...
void  rmaPropagate111wn(UB  * pcode, scalar  val);
...
void  rmaPropagate112wn(UB  * pcode, scalar  val);
