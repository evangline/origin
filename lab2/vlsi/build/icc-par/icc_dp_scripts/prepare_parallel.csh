...
set perl_path = /usr/bin/perl
   ...
   if ($found_Perl == 0) then
	echo "*ICC-DP-RM: $perl_path not found!"
        ...
        echo "*ICC-DP-RM: Please update first line of icc_dp_scripts/prepare_parallel.pl with correct Perl path."
	exit
   endif
...
./icc_dp_scripts/prepare_parallel.pl $argv[1] $argv[2] $argv[3]

#echo ""

echo "*ICC-DP-RM: prepare_parallel program has completed."
echo "*ICC-DP-RM: Run directories have been prepared."
echo "*ICC-DP-RM: Please refer to icc_dp_scripts/prepare_parallel.ReadMe.txt Usage section for further instructions."
echo ""
