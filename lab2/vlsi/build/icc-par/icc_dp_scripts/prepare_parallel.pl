...
########################
{
if (-e "./icc_dp_scripts/macro_placement_exploration_dp.tcl") {
  print "*ICC-DP-RM: icc_dp_scripts/macro_placement_exploration_dp.tcl found\n";
} else {
...
########################
{
open (explore_file,"./icc_dp_scripts/macro_placement_exploration_dp.tcl") || die "file ./icc_dp_scripts/macro_placement_exploration_dp.tcl can not be opened";
...
foreach (@run_name) {
 ...
 system "ln -s ../setup ../icc_scripts ../icc_zrt_scripts ../icc_dp_scripts ../${REPORTS_DIR} ../${RESULTS_DIR} ../snapshot ${run_number}";
 system "mv ${run_number}/RM_tmp_lib_safe_to_delete ${run_number}/${MW_DESIGN_LIBRARY}";

 open (explore_file,"./icc_dp_scripts/macro_placement_exploration_dp.tcl") || die "file $explore_file can not be opened";
 open (to_file,">${run_number}/${run_number}.tcl") || die "file $to_file can not be opened";
 print to_file "source setup/icc_setup.tcl\n";
 print to_file "source icc_dp_scripts/proc_explore.tcl\n";
